 ...
 * @author DELL
 */
public class TimKiemDocGia extends javax.swing.JFrame {

    /**
     * Creates new form TimKiemDocGia
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimKiemDocGia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TimKiemDocGia().setVisible(true);
            }
        });
    }
